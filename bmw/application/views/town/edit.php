            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
						 <form method="post" id="add_category" action="<?php echo base_url('town/editpost');?>">
                            <input type="hidden" name="t_id" id="t_id" value="<?php echo isset($edit_town['t_id'])?$edit_town['t_id']:''?>" >
							...
							<div class="row ">
                                        ...
                                        <div class="form-group col-md-6">
											...
											<?php if($list['d_id']==$edit_town['district_name']){ ?>
										 ...
										 <div class="form-group col-md-6">
                                            ...
                                            <input id="name" type="text" class="form-control" name="town_name" value="<?php echo isset($edit_town['town_name'])?$edit_town['town_name']:''?>">
                                        </div>
