	...
	<table width="100%" style="border-bottom:none">
		...
		<tr style="border-bottom:none;padding:0;height:5mm;">
			<td colspan="3" style="border-bottom:none;padding:0;height:5mm">
				...
				<h3 style="text-align:center;">District:<?php echo isset($month_name['name'])?$month_name['name']:''?></h3>
			</td>
		</tr>
	</table>
	
	<?php if(isset($district_wise_reports)&& count($district_wise_reports)>0){?>
	<table width="100%" >
		...
		<?php $cnt=1; foreach($district_wise_reports as $list){?>
		<tr>
