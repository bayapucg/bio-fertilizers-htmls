                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Edit Godown Stock Point</h4>
                        </div>
                        <div class="card-body">
	<form id="add_group" method="post" action="<?php echo base_url('godownstock/editpost');?>" enctype="multipart/form-data">
      	    <input type="hidden" name="g_id" id="g_id" value="<?php echo isset($edit_godownstock['g_id'])?$edit_godownstock['g_id']:''?>" >  
				...
				<div class="row">
						...
						<?php if($list['e_id']==$edit_godownstock['name_of_gl']){ ?>
						...
						<div class="form-group">
							<label>Month</label>
                             <input  type="date" value="<?php echo isset($edit_godownstock['month'])?$edit_godownstock['month']:''?>" class="form-control" name="month">
							</div>
						</div>
						...
						<div class="form-group">
							 <label>Branch</label>
                             <input type="text" value="<?php echo isset($edit_godownstock['branch'])?$edit_godownstock['branch']:''?>" class="form-control" name="branch">
							</div>
						</div>
		...
		<div class="row">
			...
			<div class="col-md-12 col-md-offset-12">
				...
				<tbody>
					<?php $cnt=1;foreach($edit_godownstock['godownstock_details'] as $lis){ ?>
