                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Pending BMW invoice </h4>
                        </div>
                        <div class="card-body">
						 <form  target="_blank"  method="post" id="add_category" action="<?php echo base_url('bmwinvoice/pendingbill'); ?>">
                            <div class="row ">
							...
							<div class="form-group col-md-4">
											...
											<div class="">
												<select class="form-control" name="month">
													<option value="">Select</option>
									<?php if(isset($months_list)&& count($months_list)>0){?>
								<?php foreach ($months_list as $list){ ?>
								<option value="<?php echo $list['m_id']; ?>"><?php echo $list['months']; ?></option>
								<?php }?>
								<?php }?>
								</select>
											</div>
