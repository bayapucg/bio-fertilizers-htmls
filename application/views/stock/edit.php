            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
	<form id="add_group" method="post" action="<?php echo base_url('stock/editpost');?>" enctype="multipart/form-data">
      	    <input type="hidden" name="s_id" id="s_id" value="<?php echo isset($edit_stock['s_id'])?$edit_stock['s_id']:''?>" >  
				...
				<div class="row">
						...
						<?php if($list['e_id']==$edit_stock['name_of_gl']){ ?>
						...
						<div class="form-group">
							<label>Month</label>
                             <input  type="date" value="<?php echo isset($edit_stock['month'])?$edit_stock['month']:''?>" class="form-control" name="month">
							</div>
						</div>
						...
						<div class="form-group">
							 <label>Branch</label>
                             <input type="text" value="<?php echo isset($edit_stock['branch'])?$edit_stock['branch']:''?>" class="form-control" name="branch">
							</div>
						</div>
		...
		<div class="row">
			...
			<div class="col-md-12 col-md-offset-12">
				...
				<tbody>
					<?php $cnt=1;foreach($edit_stock['stock_details'] as $lis){ ?>
					  ...
					  <td class="form-group">
						...
						<td class="text-center" valign="center"><a href="javascript:void(0);" onclick="remove_img('<?php echo $lis['s_d_id']; ?>','<?php echo $cnt; ?>')">X</a></td>	
