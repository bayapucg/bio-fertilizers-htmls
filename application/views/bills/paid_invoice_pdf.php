...
<div style="padding:10px">
	...
	<table width="100%" style="border:none;padding:10px;">
		<tr>
			...
			<td style="border-left:none;">
			<div><strong>Received Amount</strong><span style="margin-left:1.4mm">:<span style="border:1px solid #ddd;padding:4px">&nbsp; &nbsp;<?php echo (isset($month_name['recived_amount'])?$month_name['recived_amount']:'')?></span></span></div>
...
-<?php echo isset($list['years'])?$list['years']:''?></td>
		...
		<tr>
			...
			<th>
				Total Amount=<?php echo isset($month_name['total_amount'])?$month_name['total_amount']:'0'?>			
			</th>
			<th>
				Received Amount=<?php echo isset($month_name['paid'])?$month_name['paid']:'0'?>
			</th>
			<th>
				Discount Amount=<?php echo isset($month_name['discounts'])?$month_name['discounts']:'0'?>
			</th>
			<th>
				Pending Amount=	<?php echo isset($month_name['pending'])?$month_name['pending']:'0'?>
			</th>
